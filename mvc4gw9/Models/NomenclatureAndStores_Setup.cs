    ...
    public class DBInitializer : DropCreateDatabaseAlways<DBContext>
    {
        protected override void Seed(DBContext context)
        {
            ...
            List<NomenclatureInStore> nomenclatureinstores = new List<NomenclatureInStore>() 
            {
                ...
                new NomenclatureInStore {Id=54, StoreId=1, NomenclatureId=12, FeaturesSet=62, Amount=3},
                new NomenclatureInStore {Id=55, StoreId=1, NomenclatureId=12, FeaturesSet=63, Amount=1},
                new NomenclatureInStore {Id=56, StoreId=1, NomenclatureId=12, FeaturesSet=64, Amount=2},
                new NomenclatureInStore {Id=57, StoreId=2, NomenclatureId=12, FeaturesSet=65, Amount=2},
                new NomenclatureInStore {Id=58, StoreId=3, NomenclatureId=12, FeaturesSet=66, Amount=2},
                new NomenclatureInStore {Id=59, StoreId=3, NomenclatureId=12, FeaturesSet=67, Amount=1},
                new NomenclatureInStore {Id=60, StoreId=1, NomenclatureId=12, FeaturesSet=68, Amount=6},
                new NomenclatureInStore {Id=61, StoreId=3, NomenclatureId=12, FeaturesSet=69, Amount=7},
                new NomenclatureInStore {Id=62, StoreId=2, NomenclatureId=12, FeaturesSet=70, Amount=2},
                new NomenclatureInStore {Id=63, StoreId=3, NomenclatureId=12, FeaturesSet=71, Amount=4},
                new NomenclatureInStore {Id=64, StoreId=2, NomenclatureId=12, FeaturesSet=72, Amount=3},
                new NomenclatureInStore {Id=65, StoreId=2, NomenclatureId=12, FeaturesSet=73, Amount=2},
                new NomenclatureInStore {Id=66, StoreId=1, NomenclatureId=12, FeaturesSet=74, Amount=4},
